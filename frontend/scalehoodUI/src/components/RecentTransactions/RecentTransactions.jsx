      ...
      <CardContent>
        ...
        <List>
          <ListItem sx={{ paddingLeft: 0, paddingRight: 0, fontWeight: 700, color: '#6bcab5'}}>
            <ListItemText primary="Ticker" sx={{ width: '20%', textAlign: 'center' }} />
            <ListItemText primary="Transaction" sx={{ width: '20%', textAlign: 'center' }} />
            <ListItemText primary="Price" sx={{ width: '20%', textAlign: 'center' }} />
            <ListItemText primary="Amount" sx={{ width: '20%', textAlign: 'center' }} />
          </ListItem>
          ...
          {transactions.map((transaction, index) => (
            <React.Fragment key={index}>
              <ListItem sx={{ paddingLeft: 0, paddingRight: 0, color: '#6bcab5',fontWeight: 'bold' }}>
                <ListItemText primary={transaction.name} sx={{ width: '20%', textAlign: 'center' }} />
                <ListItemText primary={transaction.type} sx={{ width: '20%', textAlign: 'center' }} />
                <ListItemText primary={`$${transaction.price}`} sx={{ width: '20%', textAlign: 'center'}} />
                <ListItemText primary={transaction.totalAmount} sx={{ width: '20%', textAlign: 'center'}} />
              </ListItem>
